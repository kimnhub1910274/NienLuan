...
class CategoryProduct extends Controller
{
    ...
    public function show_cate_home($cate_id){
        ...
        $cate_by_id = DB::table('tbl_product')->join('tbl_cate_pro','tbl_product.category_id','=','tbl_cate_pro.cate_id')->where('tbl_cate_pro.cate_id',$cate_id)->get();
        $cate_name = DB::table('tbl_cate_pro')->where('tbl_cate_pro.cate_id',$cate_id)->limit(1)->get();
        return view('pages.category.show_cate')->with('category',$cate_product)->with('cate_by_id',$cate_by_id)->with('cate_name',$cate_name);
    }
