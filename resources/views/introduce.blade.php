        ...
        <main>
            <div class="container">
                <div class="row " style="margin-top: 150px; margin-bottom:-100px;">
                    <div class="col-5">
                        <img src="{{{'public/images/gioithieu1.jpg'}}}" alt="" style="width:500px; height:510px;">
                        </div>
                        <div class="col-7" style="text-align: justify;">
                        <h3>CHÍNH SÁCH BẢO HÀNH & SỬA CHỮA</h3>
                        <p><b>Khi mua sắm sản phẩm tại SHE , bạn sẽ nhận được đặc
                            quyền bảo hành trọn đời miễn phí!</b></p>
                        ...
                        <p>- Cửa hàng chỉ bảo hành/sửa chữa đơn giản như cắt gấu, bóp nới sản phẩm. Không nhận sửa chữa
                            các tình tiết phức tạp có thể làm thay đổi thiết kế
                            chuẩn của sản phẩm hoặc các sản phẩm gặp vấn đề như bị phai màu,
                        ...
                        <p><b>Mọi thắc mắc liên quan đến chính sách bảo hành trọn đời.
                             Vui lòng liên hệ: 0246.662.3434</b></p>
                    </div>
                    ...
                    <div class="col-8" style="width:500px; height:510px;margin-top: 50px;">
                        <img src="{{{'public/images/gioithieu2.jpg'}}}" alt="">
                    </div>
                </div>
            </div>
        </main>
